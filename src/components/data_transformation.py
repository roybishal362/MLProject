...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_faeture_train_df = train_df[target_column_name]

            input_features_test_df = test_df.drop(columns=[target_column_name],axis=1)
            target_faeture_test_df = test_df[target_column_name]
            ...
            test_arr = np.c[
                input_features_test_arr,np.array(target_faeture_test_df)
            ]
